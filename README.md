...
O script alimenta uma tabela no excel a cada compra (finalizar compra) e ao final do dia (finalizar o dia) alimento outro arquivo   .xlsx com o faturamento do dia. Tudo controlado pela biblioteca [Pandas](https://pandas.pydata.org/) do python.
